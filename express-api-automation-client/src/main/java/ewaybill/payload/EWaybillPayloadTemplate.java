...
public class EWaybillPayloadTemplate {
    ...
    //generating payload for generating E-Waybill
...
//            newPayload.put("docDate", dateFormat.format(invoiceDate));
            newPayload.put("docDate", ExpressDateTimeUtility.getDateMonthYearFormatDate(0L));
        } catch (Exception e) {
            e.printStackTrace(); // Handle date parsing exception
        }

        newPayload.put("docNo", ExpressDateTimeUtility.getModularCurrentTimeStamp());
        ...
        newPayload.put("transDocDate", ExpressDateTimeUtility.getDateMonthYearFormatDate(0L));
    ...
    //Item map having details of the item to be shipped
    ...
    //static payload required in generating E-Waybill
    //Pre-filled data for generating E-Waybill
    public static Map<String, Object> getStaticPayload() {
        ...
        tripItem.put("invoiceNo", ExpressDateTimeUtility.getModularCurrentTimeStamp());

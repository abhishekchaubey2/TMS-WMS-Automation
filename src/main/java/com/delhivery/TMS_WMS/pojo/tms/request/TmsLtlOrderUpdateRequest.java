...
/**
 * TMS LTL Order Update Request
 */
public class TmsLtlOrderUpdateRequest {
    ...
    @JsonProperty("boxDimension")
    private List<BoxDimension> boxDimension;
    ...
    public TmsLtlOrderUpdateRequest() {}
    ...
    public List<BoxDimension> getBoxDimension() { return boxDimension; }
    public void setBoxDimension(List<BoxDimension> boxDimension) { this.boxDimension = boxDimension; }
    ...
    /**
     * Box Dimension nested class
     */
    public static class BoxDimension {
        @JsonProperty("length")

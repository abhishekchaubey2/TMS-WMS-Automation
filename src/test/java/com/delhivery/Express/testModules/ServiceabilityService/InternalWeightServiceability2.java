...
public class InternalWeightServiceability2 extends BaseTest {
	...
	public InternalWeightServiceability2() {
...
//			assertKeyValue("cpdt", "Heavy", pkgdetails.packages.get(0).cpdt);
	...
	//WTRULE -> Predicted_CTLG , DONE
	@DataProvider(name = "Weight_updated_on_packages_after_Manifestation", parallel = false)
	public Object[][] Weight_updated_on_packages_after_Manifestation() {
		return new Object[][] { 
			...
			{ "Scenario:: B2C MPS with Master Package only with weight more than 10 kg ", "B2C MPS WITH MCOUNT 1" ,"Del_B_RPC (Delhi)", "IND110037AAB", "N", "1209", "null", "null", "Delhi", null, null, "Heavy", "Gurgaon_Kadipur (Haryana)", null, "DTUP-231", "UD", "Center changed by system","","",""},
			...
			{ "Scenario:: NO DATA with weight less than 10 kg ", "NO DATA" , "GGN_DPC (Haryana)", "IND122001AAA", "N", "|dffdf448", "true", "IND122001AAB", "Gurgaon", null, "", "B2B", "GGN_DPC (Haryana)", null, "X-UCI", "UD", "Manifest uploaded","","",""},
			{ "Scenario:: Partially Manifested package with weight more than 10 kg", "PARTIALLY MANIFESTED" ,"Gurgaon (Haryana)", "IND122001AAB", "null", "1209", "null", "IND122001AAB", "null", "null", "", "null", "Gurgaon (Haryana)", "null", "X-SPM", "UD", "Shipment partially manifested","","",""}
			};
	}
	
	@Test(dataProvider = "Weight_updated_on_packages_after_Manifestation" , enabled = false)
	public void VerifyServiceabilityTriggerAfterWeightUpdationAfterManifestation(String Scenario, String type, String cn , String cnid,
	...
	@Test(dataProvider = "Weight_updated_on_packages_after_Manifestation_With_Client_WtRule" , enabled = false)

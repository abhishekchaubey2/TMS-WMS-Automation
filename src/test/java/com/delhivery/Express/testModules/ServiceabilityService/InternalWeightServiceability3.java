...
public class InternalWeightServiceability3 extends BaseTest {
	...
	public InternalWeightServiceability3() {
...
//			assertKeyValue("cpdt", "Heavy", pkgdetails.packages.get(0).cpdt);
	...
	//SRV TRIGGER FOR IN-TRANSIT SHIPMENTS , WT RULE -> "Sorter", DOne except Heavy assertion
			@DataProvider(name = "Weight_updated_With_WTRule_Sorter_on_packages_after_GI_", parallel = false)
			public Object[][] Weight_updated_With_WTRule_Sorter_on_packages_after_GI_() {
				return new Object[][] { 
					{ "Scenario:: B2B package with weight less than 10 kg", "B2B" ,"Del_B_RPC (Delhi)", "IND110037AAB", "", "1209", "true", "IND110092AAB", "Delhi", "null", "", "B2C", "Del_B_RPC (Delhi)", "null", "DTUP-231", "UD", "Center changed by system","","",""},
					...
					{ "Scenario:: B2C MPS with weight more than 10 kg ", "B2C MPS" ,"Gurgaon_Kadipur (Haryana)", "IND122001AAD", "N", "249", "null", "IND110092AAB", "Gurgaon", "null", "", "Heavy", "Gurgaon_Kadipur (Haryana)", "null", "DTUP-231", "UD", "Center changed by system","","",""},
			...
			@Test(dataProvider = "Weight_updated_With_WTRule_Sorter_on_packages_after_GI_" , enabled = true)
			public void VerifyServiceabilityTriggerAfterWeightUpdationAfterGIWithSorterWTRULE(String Scenario, String type, String cn , String cnid,

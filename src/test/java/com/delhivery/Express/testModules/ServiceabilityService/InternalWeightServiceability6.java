...
public class InternalWeightServiceability6 extends BaseTest {
	...
	public InternalWeightServiceability6() {
...
//			assertKeyValue("cpdt", "Heavy", pkgdetails.packages.get(0).cpdt);
	...
	//switch to second dictionary use pin -> 110037 , for COD -> Delhi_Govindpura (Delhi)
	@DataProvider(name = "Switch_to_secondary_CN", parallel = false)
	public Object[][] Switch_to_secondary_CN() {
		return new Object[][] { 
			{ "Scenario:: B2B package with weight more than 10 kg", "B2B" ,"Delhi_Govindpura (Delhi)", "IND110051AAA", "", "null", "true", "IND110092AAB", "Delhi", "null", "", "B2B", "null", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""},
			{ "Scenario:: B2C package with weight more than 10 kg", "B2C" , "Delhi_Govindpura (Delhi)", "IND110051AAA", "", "null", "null", "IND110092AAB", "Delhi", "null", "", "Heavy", "Delhi_Govindpura (Delhi)", "null", "DTUP-231", "UD", "Center changed by system","","",""},
			{ "Scenario:: Heavy package with weight more than 10 kg", "HEAVY" ,"Delhi_Govindpura (Delhi)", "IND110051AAA", "", "null", "true", "IND110092AAB", "Delhi", "null", "null", "Heavy", "null", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""}};
	}
	
	@Test(dataProvider = "Switch_to_secondary_CN" , enabled = true)
	public void VerifyServiceabilitySwitchtoSecondaryCN(String Scenario, String type, String cn , String cnid,
	...
	public Object[][] Ewaybill_Case() {
		return new Object[][] { 
			{ "Scenario:: B2B package with weight more than 10 kg", "B2B" ,"Delhi_Paschim_DC (Delhi)", "IND110087AAA", "", "1395", "true", "IND110092AAB", "Delhi", "null", "null", "B2B", "Delhi_Paschim_DC (Delhi)", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""},
			{ "Scenario:: B2C package with weight more than 10 kg", "B2C" , "Samalkha_DC", "IND000000AEY", "", "591", "false", "IND110092AAB", "Delhi", "null", "null", "", "Samalkha_DC", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""},
			};
	}
	
	@Test(dataProvider = "Ewaybill_Case" , enabled = false)
	public void VerifyEwaybillSwitchAfterServiceabilityTrigger(String Scenario, String type, String cn , String cnid,
			String rgn , String sc, String srv , String ocid , String cnc , String dpc , String wvcid ,
			String cpdt, String cn1, String dpcid,String cs_nsl,String cs_st,String cs_sr,String cs_ss,String pin,String rpin) {
		List<String> waybills = new ArrayList<String>();
		HashMap<String, String> Payload = new HashMap<>();
		...
		Payload.put("add", "Sec 44 gurgaon");
		Payload.put("payment_mode","COD");
	...
	//Addfix updated to test
	@DataProvider(name = "Add_updated_to_test", parallel = false)
	public Object[][] Add_updated_to_test() {
		return new Object[][] { 
			{ "Scenario:: B2B package with weight less than 10 kg", "B2B" ,"Del_B_RPC (Delhi)", "IND110037AAB", "N", "1209", "true", "IND110092AAB", "Delhi", "null", "", "B2C", "Del_B_RPC (Delhi)", "null", "DTUP-203", "UD", "Package details changed by shipper","","",""},
			{ "Scenario:: B2C package with weight more than 10 kg", "B2C" , "Gurgaon_Kadipur (Haryana)", "IND122001AAD", "N", "249", "null", "IND110092AAB", "Gurgaon", "null", "", "Heavy", "Gurgaon_Kadipur (Haryana)", "null", "DTUP-203", "UD", "Package details changed by shipper","","",""},
			{ "Scenario:: Heavy package with weight less than 10 kg", "HEAVY" , "Del_B_RPC (Delhi)", "IND110037AAB", "N", "1209", "true", "IND110092AAB", "Delhi", "null", "null", "B2C", "Del_B_RPC (Delhi)", "null", "DTUP-203", "UD", "Package details changed by shipper","","",""},
			{ "Scenario:: B2B MPS with weight less than 10 kg ", "B2B MPS" , "Gurgaon_Kadipur (Haryana)", "IND122001AAD", "N", "249", "true", "IND110092AAB", "Gurgaon", "null", "", "B2B", "Gurgaon_Kadipur (Haryana)", "null", "DTUP-203", "UD", "Package details changed by shipper","","",""}
			};
	}

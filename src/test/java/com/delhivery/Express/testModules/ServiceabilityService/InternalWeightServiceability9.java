...
public class InternalWeightServiceability9 extends BaseTest {
	...
	public InternalWeightServiceability9() {
...
//			assertKeyValue("cpdt", "Heavy", pkgdetails.packages.get(0).cpdt);
	...
	//WTRULE = CLIENT, In transit shipment -> DONE
	@DataProvider(name = "Weight_updated_on_packages_after_GI_With_Client_WtRule", parallel = false)
	public Object[][] Weight_updated_on_packages_after_GI_With_Client_WtRule() {
		return new Object[][] { 
			{ "Scenario:: B2B package with weight less than 10 kg", "B2B" ,"Gurgaon_Kadipur (Haryana)", "IND122001AAD", "N", "249", "true", "IND110092AAB", "Gurgaon", "null", "", "B2B", "Gurgaon_Kadipur (Haryana)", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""},
			{ "Scenario:: B2C package with weight more than 10 kg", "B2C" ,"Del_B_RPC (Delhi)", "IND110037AAB", "N", "1209", "null", "IND110092AAB", "Delhi", "null", "", "", "Del_B_RPC (Delhi)", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""},
			{ "Scenario:: Heavy package with weight less than 10 kg", "HEAVY" ,"Gurgaon_Kadipur (Haryana)", "IND122001AAD", "N", "249", "true", "IND110092AAB", "Gurgaon", "null", "null", "Heavy", "Gurgaon_Kadipur (Haryana)", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""},
			{ "Scenario:: B2B MPS with internal child with weight less than 10 kg", "B2B MPS WITH INTERNAL CHILD" ,"Gurgaon_Kadipur (Haryana)", "IND122001AAD", "N", "249", "true", "IND110092AAB", "Gurgaon", "null", "", "B2B", "Gurgaon_Kadipur (Haryana)", "null", "X-PIOM", "UD", "Shipment Recieved at Origin Center","","",""}
			};
	}
	
	@Test(dataProvider = "Weight_updated_on_packages_after_GI_With_Client_WtRule" , enabled = true)
	public void VerifyNoServiceabilityTriggerAfterGIWithClientWTRULE(String Scenario, String type, String cn , String cnid,
		...
		if(!child_waybill.equalsIgnoreCase(waybill)) {
			...
			public Object[][] weight_updated_on_diff_state_shipments() {
				return new Object[][] {
						...
						{"Scenario:: B2C Package with weight more than 10 kg", "B2C","RTO", "Del_B_RPC (Delhi)", "IND110037AAB", "N", "1209", "null", "IND110092AAB", "Delhi", "null", "", "", "Del_B_RPC (Delhi)", "null", "RT-110", "DL", "RTO due to poor packaging","","",""},
						{"Scenario:: B2C Package with weight more than 10 kg", "B2C" , "LOST", "Del_B_RPC (Delhi)", "IND110037AAB", "N", "1209", "null", "IND110092AAB", "Delhi", "null", "", "", "Del_B_RPC (Delhi)", "null", "LT-100", "LT", "Shipment LOST","","",""},

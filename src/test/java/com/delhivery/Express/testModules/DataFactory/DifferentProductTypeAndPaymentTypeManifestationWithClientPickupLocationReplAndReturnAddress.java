...
public class DifferentProductTypeAndPaymentTypeManifestationWithClientPickupLocationReplAndReturnAddress extends BaseTest {
    ...
    private void testDifferentProductTypeAndPaymentTypeManifestationWithClientPickupLocationReplAndReturnAddress(String scenario, String productType, String paymentType) {
        ...
        ThreadLocal<HashMap<String, String>> data = TestModuleHelper.prepareManifestDataWithPinReturnAddAndReplPinAdd(null, productType, paymentType, "122003", "testingDummyData", "test", "122005","buyback add","301201","Noida","Uttar Pradesh");
        data.get().put("cwh_sent","true");
        data.get().put("pickup_location","HQAPIREGRESSION");
    ...
    @Test(dependsOnMethods = "testDifferentProductTypeAndPaymentTypeManifestationWithClientPickupLocationReplAndReturnAddress")
    private void writeDataToCSV() {
        csvData.put("Headers", new ArrayList<>(Arrays.asList("Package Type and Payment Type", "Master Waybill", "Child Waybill")));
        CsvFileUtils.writeDataToCSV(CoreConstants.REG_CHECKLIST_PATH, "DifferentProductTypeAndPaymentTypeManifestationWithClientPickupLocationReplAndReturnAddress.csv", csvData);
    }
}

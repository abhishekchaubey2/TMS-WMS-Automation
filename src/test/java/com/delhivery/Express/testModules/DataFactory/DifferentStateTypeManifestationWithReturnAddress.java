...
public class DifferentStateTypeManifestationWithReturnAddress extends BaseTest {
    ...
    private void testDifferentStateTypeManifestationWithReturnAddress(String scenario, String productType, String state) {
        ...
        ThreadLocal<HashMap<String, String>> data = TestModuleHelper.prepareManifestDataWithPinAddReturnAddAndReturnPin(null, productType, null, "122003", "testingDummyData", "test", "122005");
    ...
    @Test(dependsOnMethods = "testDifferentStateTypeManifestationWithReturnAddress")

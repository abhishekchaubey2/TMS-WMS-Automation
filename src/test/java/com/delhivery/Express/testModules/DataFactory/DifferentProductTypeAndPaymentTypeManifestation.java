...
public class DifferentProductTypeAndPaymentTypeManifestation extends BaseTest {
    ...
    private void testDifferentProductTypeAndPaymentTypeManifestation(String scenario, String productType, String paymentType) {
        ...
        ThreadLocal<HashMap<String, String>> data = TestModuleHelper.prepareManifestData(null, productType, paymentType, null);

...
public class DifferentProductTypeAndPaymentTypeManifestationWithReplAndReturnAddress extends BaseTest {
    ...
    private void testDifferentProductTypeAndPaymentTypeManifestationWithReplAndReturnAddress(String scenario, String productType, String paymentType) {
    ...
    @Test(dependsOnMethods = "testDifferentProductTypeAndPaymentTypeManifestationWithReplAndReturnAddress")
    private void writeDataToCSV() {
        csvData.put("Headers", new ArrayList<>(Arrays.asList("Package Type and Payment Type", "Master Waybill", "Child Waybill")));
        CsvFileUtils.writeDataToCSV(CoreConstants.REG_CHECKLIST_PATH, "DifferentProductTypeAndPaymentTypeManifestationWithReplAndReturnAddress.csv", csvData);
    }
}

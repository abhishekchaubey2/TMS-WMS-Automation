...
public class UnsetReturnDdIdForB2B extends BaseTest {
    ...
    public UnsetReturnDdIdForB2B(String factoryScenario, Integer packageCount) {
    ...
    public static Object[][] Different_type_pkg() {
        return new Object[][]{
                {"Scenario::When product type is B2B and package count 0", "B2B", 0},
                {"Scenario::When product type is B2B MPS and package count 4", "B2B MPS", 4},
                {"Scenario::When product type is B2B MPS and package count 10", "B2B MPS", 10},
                {"Scenario::When product type is B2B MPS and package count 11", "B2B MPS", 11},
        };
    }
    ...
    private static Object[] getDifferentTypePkgAndPackageCount(String scenario, String pdt, Integer packageCount) {
        return new Object[]{new UnsetReturnDdIdForB2B(scenario, packageCount)};
    }

    @Test(dataProvider = "Different_state_type_pkg_for_dd_unset", dataProviderClass = manifestationData.class)
    private void testUnsetReturnDdIdForB2B(String scenario, String state) {
        if (unsetReturnDdIdUtility.shouldProcess(scenario,factoryScenario)) {

            manifestData.set(TestModuleHelper.prepareManifestData(null, "B2B", null, null).get());

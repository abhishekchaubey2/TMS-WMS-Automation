...
public class EWayBillRestInternalAPI extends BaseTest {
    ...
    public EWayBillRestInternalAPI(String productType, String paymentType) {
    ...
    public static Object[] getDifferentPDTType(String scenario, String productType, String state) {
        return new Object[]{new EWayBillRestInternalAPI(productType, state)};
    }

    @Test(dataProvider = "eWaybillRestInternalDataProvider", dataProviderClass = EWaybillDataProvider.class)
    public void testAPIEWayBillUpdateByInternalAPI(String scenario, String documentNumber, String eWayBillNumber, String rs, String api) {

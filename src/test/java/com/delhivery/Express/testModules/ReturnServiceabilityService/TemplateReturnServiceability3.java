...
public class TemplateReturnServiceability3 extends BaseTest{
...
//	private String product_type, payment_mode, packageStatus, bagSeal, ocid, cnid, client;
	...
	public TemplateReturnServiceability3() {
	...
	@DataProvider(name = "Updated_RPin_Has_No_Data_While_Custom_Data_Set_In_Client_Config", parallel = false)
	public Object[][] Updated_RPin_Has_No_Data_While_Custom_Data_Set_In_Client_Config() {
		return new Object[][] { 
			{ "Scenario:: B2B package", "B2B" ,"Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND110092AAB", "Mumbai", "null", "", "B2B", "Mumbai MIDC (Maharashtra)", "null", "DTUP-203", "RT", "Package details changed by shipper", "Noida (Uttar Pradesh)", "Noida (Uttar Pradesh)", "IND201301AAB", "null", "null", "Noida", "null"},
			{ "Scenario:: B2C package", "B2C" , "Barauli_SiwanRd_D (Bihar)", "IND841405AAA", "E", "null", "null", "IND110092AAB", "Barauli", "null", "null", "", "Barauli_SiwanRd_D (Bihar)", "null", "DTUP-203", "RT", "Package details changed by shipper", "Delhi_AshokNgr_DC (Delhi)", "Delhi_AshokNgr_DC (Delhi)", "IND110096AAB", "null", "null", "Delhi", "null"},
			{ "Scenario:: Heavy package", "HEAVY" ,"Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND110092AAB", "Mumbai", "null", "null", "Heavy", "Mumbai MIDC (Maharashtra)", "null", "DTUP-203", "RT", "Package details changed by shipper", "Del_Okhla_PC (DELHI)", "null", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2B MPS", "B2B MPS" , "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND110092AAB", "Mumbai", "null", "null", "B2B", "Mumbai MIDC (Maharashtra)", "null", "DTUP-203", "RT", "Package details changed by shipper", "Noida (Uttar Pradesh)", "Noida (Uttar Pradesh)", "IND201301AAB", "null", "null", "Noida", "null"},
			};
	}
	
	@Test(dataProvider = "Updated_RPin_Has_No_Data_While_Custom_Data_Set_In_Client_Config" , enabled = true)
	public void VerifyCustomServiceabilityRaddUpdateAndNewRpinHasNoData(String Scenario, String type, String cn , String cnid,
		...
		Payload.put("return_pin", "110030");
		Payload.put("return_add", "G5FR+W6J, Chatri Wala Kuan, Lado Sarai, New Delhi, Delhi 110030");
...
//		}
	...
	public void EdtVsStaging(String Scenario, String type) {
		...
		Payload1.put("client", "custom_srv_client_2");
	...
	//Restricted Mapper client
	//Not required fro this template
	@DataProvider(name = "Restricted_Mapper_Case", parallel = false)
	public Object[][] Restricted_Mapper_Case() {
		return new Object[][] { 
			{ "Scenario:: B2B package", "B2B" ,"Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "null", "Mumbai", "null", "null", "B2B", "Mumbai MIDC (Maharashtra)", "null", "X-UCI", "UD", "Manifest uploaded", "Del_Okhla_PC (Delhi)", "null", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2C package", "B2C" , "Barauli_SiwanRd_D (Bihar)", "IND841405AAA", "E", "null", "null", "null", "Barauli", "null", "null", "", "Barauli_SiwanRd_D (Bihar)", "null", "X-UCI", "UD", "Manifest uploaded", "Del_Okhla_PC (Delhi)", "null", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: Heavy package", "HEAVY" ,"Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "null", "Mumbai", "null", "null", "Heavy", "Mumbai MIDC (Maharashtra)", "null", "X-UCI", "UD", "Manifest uploaded", "Del_Okhla_PC (Delhi)", "null", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2B MPS", "B2B MPS" , "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "null", "Mumbai", "null", "null", "B2B", "Mumbai MIDC (Maharashtra)", "null", "X-UCI", "UD", "Manifest uploaded", "Del_Okhla_PC (Delhi)", "null", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			};
	}
	...
	public Object[][] Different_payment_mode() {
		return new Object[][] { 
			{ "Scenario:: B2B package", "B2B" ,"COD", "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND110092AAB", "Mumbai", "null", "", "B2B", "Mumbai MIDC (Maharashtra)", "null", "RT-101", "RT", "Returned as per Client Instructions", "Del_Okhla_PC (Delhi)", "Del_Okhla_PC (Delhi)", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2B package", "B2B" ,"Pre-paid", "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND110092AAB", "Mumbai", "null", "", "B2B", "Mumbai MIDC (Maharashtra)", "null", "RT-101", "RT", "Returned as per Client Instructions", "Del_Okhla_PC (Delhi)", "Del_Okhla_PC (Delhi)", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2B package", "B2B" ,"Pickup", "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND400093AAA", "Mumbai", "null", "null", "B2B", "Mumbai MIDC (Maharashtra)", "null", "X-ASP", "PP", "Pickup scheduled", "Del_Okhla_PC (Delhi)", "Del_Okhla_PC (Delhi)", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2B package", "B2B" ,"Cash", "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "null", "Mumbai", "null", "null", "B2B", "Mumbai MIDC (Maharashtra)", "null", "X-UCI", "PP", "Manifest uploaded", "Del_Okhla_PC (Delhi)", "Del_Okhla_PC (Delhi)", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"},
			{ "Scenario:: B2B package", "B2B" ,"REPL", "Mumbai MIDC (Maharashtra)", "IND400093AAA", "W", "1028", "true", "IND110092AAB", "Mumbai", "null", "", "B2B", "Mumbai MIDC (Maharashtra)", "null", "RT-101", "RT", "Returned as per Client Instructions", "Del_Okhla_PC (Delhi)", "Del_Okhla_PC (Delhi)", "IND110044AAB", "Del_Okhla_PC (DELHI)", "IND110044AAB", "Delhi", "null"}
			};
	}

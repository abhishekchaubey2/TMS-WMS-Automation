...
public class RT_Mapper extends BaseTest {
    ...
    @DataProvider(name = "RT_Mapper_weight_updated_shipment", parallel = true)
    public Object[][] RT_Mapper_weight_updated_shipment() {
        return new Object[][]{
                ...
                {"Scenario:: B2B MPS WITH ONLY MASTER package with weight less than 15 kg", "MPS WITH MCOUNT 1", "Bhopal_Kasturba_M (Madhya Pradesh)", "IND462023AAB", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper"},
                {"Scenario:: B2B MPS WITH INTERNAL CHILD package with weight less than 15 kg", "B2B MPS WITH INTERNAL CHILD", "Bhopal_Kasturba_M (Madhya Pradesh)", "IND462023AAB", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper"},
    ...
    @Test(dataProvider = "RT_Mapper_weight_updated_shipment", enabled = true)
    public void verifyRCnForWeightUpdatedShipment(String Scenario, String type, String expectedRCn, String expectedRCnid, String expectedRDpc, String expectedRDpcid, String expectedRCty, String expectedRCns) {
        requestPayload.set(TestModuleHelper.prepareManifestDataWithPinReturnAddAndReturnPin(null, null, null, "122001", "Khadsad, Gujarat 395006", "395006").get());
        ...
        logInfo("Before raseg; rcn value :: " + pkgdetails.get().rcn);
        logInfo("Before raseg; rcns value :: " + pkgdetails.get().rcns);
        ...
        logInfo("Checking package keys :: " + waybills.get());
        pkgdetails.set(apiCtrl.fetchPackageInfo(waybills.get().get(0), requestPayload.get()));

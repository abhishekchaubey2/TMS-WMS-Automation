...
public class RT_Mapper2 extends BaseTest {
    ApiController apiCtrl = new ApiController();

    private final static Map<String, Object> same_center_from_cwh_center = YamlReader.getYamlValues("Centers.Mumbai_MIDC");
    ...
    @DataProvider(name = "RT_Mapper_return_weight_update", parallel = true)
    public Object[][] RT_Mapper_return_weight_update() {
        return new Object[][]{
                {"Scenario:: B2C package with weight less than 15 kg", "B2C", "Suratgarh_MandiDPP_D (Rajasthan)", "IND335804AAA", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight 15kg"},
                {"Scenario:: B2C package with weight 15kg", "B2C", "Surat_Brpc (Gujarat)", "IND395010AAB", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight less than 15 kg"},
                {"Scenario:: B2B package with weight less than 15 kg", "B2B", "Suratgarh_MandiDPP_D (Rajasthan)", "IND335804AAA", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight 15kg"},
                {"Scenario:: B2B package with weight 15kg", "B2B", "Surat_Brpc (Gujarat)", "IND395010AAB", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight less than 15 kg"},
                {"Scenario:: B2C MPS package with weight less than 15 kg", "B2C MPS", "Suratgarh_MandiDPP_D (Rajasthan)", "IND335804AAA", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight 15kg"},
                {"Scenario:: B2C MPS package with weight 15kg", "B2C MPS", "Surat_Brpc (Gujarat)", "IND395010AAB", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight less than 15 kg"},
                {"Scenario:: B2B MPS with weight less than 15 kg", "B2B MPS", "Suratgarh_MandiDPP_D (Rajasthan)", "IND335804AAA", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight 15kg"},
                {"Scenario:: B2B MPS with weight 15kg", "B2B MPS", "Suratgarh_MandiDPP_D (Rajasthan)", "IND335804AAA", "Goa_Hub (Goa)", "IND403726AAA", "Surat", "rt_polymapper", "weight less than 15 kg"},
        };
    }

    @Test(dataProvider = "RT_Mapper_return_weight_update", enabled = true)
    public void verifyRCnForRtWeightUpdate(String Scenario, String type, String expectedRCn, String expectedRCnid, String expectedRDpc, String expectedRDpcid, String expectedRCty, String expectedRCns, String updateRTWeight) {
        requestPayload.set(TestModuleHelper.prepareManifestDataWithPinReturnAddAndReturnPin(null, null, null, "122001", "Khadsad, Gujarat", "395006").get());
        ...
        // Update weight -> for master only
        if (updateRTWeight.contains("weight less than 15 kg")) {
            apiCtrl.QcWtApi(waybills.get().get(0), 14999.99, "sorter", requestPayload.get());
            Utilities.hardWait(10);
        } else if (updateRTWeight.contains("weight 15kg")) {
            apiCtrl.QcWtApi(waybills.get().get(0), 15000.00, "sorter", requestPayload.get());
            Utilities.hardWait(70);
        }

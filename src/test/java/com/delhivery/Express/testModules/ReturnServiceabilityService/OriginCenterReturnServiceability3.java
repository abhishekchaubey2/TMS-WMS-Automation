...
public class OriginCenterReturnServiceability3 extends BaseTest {
    ...
    @DataProvider(name = "Origin_Center_Return_b2c_diff_state_shipments_raseg_update_pin_NSZ_center", parallel = false)
    public Object[][] Origin_Center_Return_b2c_diff_state_shipments_raseg_update_pin_NSZ_center() {
        return new Object[][] {
                ...
                {"Scenario:: Returned state shipment", "Returned", "East Delhi (Delhi)", "East Delhi (Delhi)", "IND110092AAB", "null", "null", "Delhi", "null", "DTUP-203", "RT", "Package details changed by shipper", "", "N", "1209", "null", "IND110092AAB", "null", true},
                ...
                {"Scenario:: PickedUp state shipment", "PickedUp", "Delhi_East_RPC (Delhi)", "Delhi_East_RPC (Delhi)", "IND110096AAA", "null", "null", "Delhi", "null", "DTUP-203", "PU", "Package details changed by shipper", "", "N", "1209", "null", "null", "null", true},
                { "Scenario:: REPL RETURNED state shipment", "REPL RETURNED", "Gurgaon (Haryana)", "Gurgaon (Haryana)", "IND122001AAB", "null", "null", "Gurgaon", "null", "DTUP-203", "RT", "Package details changed by shipper", "", "N", "1209", "null", "IND122001AAB", "IND122001AAB", true},
                { "Scenario:: REPL PICKUP state shipment", "REPL PICKUP", "Gurgaon (Haryana)", "Gurgaon (Haryana)", "IND122001AAB", "null", "null", "Gurgaon", "null", "DTUP-203", "PU", "Package details changed by shipper", "", "N", "1209", "null", "IND122001AAB", "IND122001AAB", true},
    ...
    @Test(dataProvider = "Origin_Center_Return_b2c_diff_state_shipments_raseg_update_pin_NSZ_center", enabled = true)
    public void verifyRcnB2CDiffStateShipmentRasegUpdatePinNSZCenter(String Scenario, String state, String expectedRCn, String expectedRCn1, String expectedRCnid, String expectedRDpc, String expectedRDpcid, String expectedRCty, String expectedRCns, String expectedCsNsl, String expectedCsSt, String expectedCsSr
        ...
        if (enable) {
            ...
            editRadd.put("client", "return_address_origin_center");
    ...
    @DataProvider(name = "Origin_Center_Return_b2b_diff_state_shipments_raseg_update_pin_NSZ_center", parallel = false)
    public Object[][] Origin_Center_Return_b2b_diff_state_shipments_raseg_update_pin_NSZ_center() {
        return new Object[][] {
                { "Scenario:: Manifest state shipment", "Manifest", "Del_B_RPC (Delhi)", "Del_B_RPC (Delhi)", "IND110037AAB", "null", "null", "Delhi", "null", "DTUP-219", "UD", "Pincode updated by Addfix", "", "N", "1209", "false", "null", "null", false},
                { "Scenario:: In Transit state shipment", "In Transit", "Del_B_RPC (Delhi)", "Del_B_RPC (Delhi)", "IND110037AAB", "null", "null", "Delhi", "null", "DTUP-219", "UD", "Pincode updated by Addfix", "", "N", "1209", "false", "IND110092AAB", "null", false},
                { "Scenario:: Pending state shipment", "Pending", "Del_B_RPC (Delhi)", "Del_B_RPC (Delhi)", "IND110037AAB", "null", "null", "Delhi", "null", "DTUP-219", "UD", "Pincode updated by Addfix", "", "N", "1209", "false", "IND400093AAA", "IND400612AAA", false},
                {"Scenario:: Returned state shipment", "Returned", "East Delhi (Delhi)", "East Delhi (Delhi)", "IND110092AAB", "null", "null", "Delhi", "null", "DTUP-203", "RT", "Package details changed by shipper", "B2B", "N", "|dffdf448", "true", "IND110092AAB", "null", true},
                {"Scenario:: PickupPending state shipment", "PickupPending", "Del_B_RPC (Delhi)", "Del_B_RPC (Delhi)", "IND110037AAB", "null", "null", "Delhi", "null", "DTUP-219", "PP", "Pincode updated by Addfix", "", "N", "1209", "false", "null", "null", false},
                {"Scenario:: PickedUp state shipment", "PickedUp", "Gurgaon (Haryana)", "Gurgaon (Haryana)", "IND122001AAB", "null", "null", "Gurgaon", "null", "DTUP-203", "PU", "Package details changed by shipper", "B2B", "N", "|dffdf448", "true", "null", "null", true},
                { "Scenario:: REPL RETURNED state shipment", "REPL RETURNED", "GGN_DPC (Haryana)", "GGN_DPC (Haryana)", "IND122001AAA", "null", "null", "Gurgaon", "null", "DTUP-203", "RT", "Package details changed by shipper", "B2B", "N", "|dffdf448", "true", "IND122001AAA", "", true},
                { "Scenario:: REPL PICKUP state shipment", "REPL PICKUP", "GGN_DPC (Haryana)", "null", "IND122001AAA", "null", "null", "Gurgaon", "null", "DTUP-203", "PU", "Package details changed by shipper", "B2B", "N", "|dffdf448", "true", "IND122001AAA", "", true},
    ...
    @Test(dataProvider = "Origin_Center_Return_b2b_diff_state_shipments_raseg_update_pin_NSZ_center", enabled = true)

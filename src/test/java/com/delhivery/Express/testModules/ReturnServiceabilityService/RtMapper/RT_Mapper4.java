...
public class RT_Mapper4 extends BaseTest {
    ...
    @DataProvider(name = "RT_Mapper_rvp_cases_weight_updated_shipment", parallel = true)
    public Object[][] RT_Mapper_rvp_cases_weight_updated_shipment() {
        return new Object[][]{
    ...
    @Test(dataProvider = "RT_Mapper_rvp_cases_weight_updated_shipment", enabled = true)
    public void verifyRCnForRVPWeightUpdatedShipment(String Scenario, String type, String expectedRCn, String expectedRCnid, String expectedRDpc, String expectedRDpcid, String expectedRCty, String expectedRCns) {
        requestPayload.set(TestModuleHelper.prepareManifestDataWithPinReturnAddAndReturnPin(null, null, "Pickup", "122001", "Khadsad, Gujarat", "395006").get());
